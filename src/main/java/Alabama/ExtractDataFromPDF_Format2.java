...
public class ExtractDataFromPDF_Format2 
{
	...
	//public static void main(String[] args) throws Exception 
	{
	    ...
	    try
    	{
    	AL_PropertyWare.securityDeposit = text.substring(text.indexOf(PDFAppConfig_Format2.securityDeposit_Prior)+PDFAppConfig_Format2.securityDeposit_Prior.length()).trim().split(" ")[0];//,text.indexOf(PDFAppConfig_Format2.securityDeposit_After));
