...
public class ExtractDataFromPDF 
{
	...
	public static void main(String args[]) throws Exception
	{
		...
		File file = new File("C:\\Gopi\\Projects\\Property ware\\Lease Close Outs\\PDFS\\Florida\\SINGLE FAMILY RESIDENCE OR CONDOMINIUM LEASE\\SINGLE FAMILY RESIDENCE OR CONDOMINIUM LEASE\\Lease_10.21_09.22_186_Auburn_Grove_Blvd_FL_Coalwell-Hathaway.pdf");
	  ...
	  //Prepayment Charge
	    ...
	    if(petFlag ==true)
	    {
	    	...
	    	System.out.println("Security Deposit = "+FL_PropertyWare.petSecurityDeposit.trim());
